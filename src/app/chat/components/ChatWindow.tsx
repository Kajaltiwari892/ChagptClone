  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-[#212121] text-white p-2 sm:p-4 md:p-6">
      ...
      <div className="relative w-full max-w-[768px]" ref={dropdownRef}>
        <div className="group relative cursor-pointer flex items-center gap-4 px-3 sm:px-5 md:px-6 py-2 sm:py-3 md:py-4 bg-[#303030] border border-white/10 rounded-3xl hover:bg-white/5  w-full h-14  hover:shadow-lg hover:shadow-black/30">
          {/* Left: Plus Icon */}
          <button
          ...
          >
            <svg
              ...
              className="text-white cursor-pointer group-hover:text-white transition-colors"
            >
