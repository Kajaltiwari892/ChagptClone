...
export function LoginModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      {/* Modal */}
      <div className="relative  bg-[#171717] rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 transform transition-all">
        {/* Content */}
        <div className="text-center">
          ...
          <Button
            ...
            disabled={isLoading}
            className="w-full bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 dark:border-gray-700 dark:bg-[#212121] dark:hover:bg-gray-700 dark:text-white"
            size="lg"
          >
            {isLoading ? (
